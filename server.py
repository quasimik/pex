...
def api_predict_pushup_status():
    ...
    predictor = tf.contrib.predictor.from_saved_model(EXPORT_DIR + '/1516551671')
    predictions = predictor({
        'neck-x': example[0],
        'neck-y': example[1],
        'neck-c': example[2],
        'right-shoulder-x': example[3],
        'right-shoulder-y': example[4],
        'right-shoulder-c': example[5],
        'right-elbow-x': example[6],
        'right-elbow-y': example[7],
        'right-elbow-c': example[8],
        'right-hand-x': example[9],
        'right-hand-y': example[10],
        'right-hand-c': example[11],
        'left-shoulder-x': example[12],
        'left-shoulder-y': example[13],
        'left-shoulder-c': example[14],
        'left-elbow-x': example[15],
        'left-elbow-y': example[16],
        'left-elbow-c': example[17],
        'left-hand-x': example[18],
        'left-hand-y': example[19],
        'left-hand-c': example[20],
        'right-hip-x': example[21],
        'right-hip-y': example[22],
        'right-hip-c': example[23],
        'right-knee-x': example[24],
        'right-knee-y': example[25],
        'right-knee-c': example[26],
        'right-foot-x': example[27],
        'right-foot-y': example[28],
        'right-foot-c': example[29],
        'left-hip-x': example[30],
        'left-hip-y': example[31],
        'left-hip-c': example[32],
        'left-knee-x': example[33],
        'left-knee-y': example[34],
        'left-knee-c': example[35],
        'left-foot-x': example[36],
        'left-foot-y': example[37],
        'left-foot-c': example[38]})
    print(predictions)
...
def createmodel():
    ...
    # endif, we should have a classifier
    return True
